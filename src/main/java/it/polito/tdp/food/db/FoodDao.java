...
public class FoodDao {
	...
	public List<String> vertici(int C){
	...
	public List<Arco> edges(){
		...
		try {
			...
			while(res.next()) {
					result.add(new Arco(res.getString("p1.portion_display_name"), res.getString("p2.portion_display_name"), res.getInt("peso")));
			}
